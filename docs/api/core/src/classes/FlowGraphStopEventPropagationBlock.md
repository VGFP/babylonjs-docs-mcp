...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphStopEventPropagationBlock

# Class: FlowGraphStopEventPropagationBlock

Defined in: [packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts:19](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts#L19)
...
> **new FlowGraphStopEventPropagationBlock**(`config?`): `FlowGraphStopEventPropagationBlock`

Defined in: [packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts:33](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts#L33)
...
> `readonly` **event**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`string`\>

Defined in: [packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts:24](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts#L24)
...
> `readonly` **stopImmediate**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`boolean`\>

Defined in: [packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts:31](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts#L31)
...
Defined in: [packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts:49](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphStopEventPropagationBlock.pure.ts#L49)
