...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphVectorSlerpBlock

# Class: FlowGraphVectorSlerpBlock

Defined in: [packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:373](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L373)
...
- `FlowGraphTernaryOperationBlock`\<`FlowGraphVector`, `FlowGraphVector`, `number`, `FlowGraphVector`\>

## Constructors

### Constructor

> **new FlowGraphVectorSlerpBlock**(`config?`): `FlowGraphVectorSlerpBlock`

Defined in: [packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:374](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L374)
...
`FlowGraphTernaryOperationBlock<FlowGraphVector, FlowGraphVector, number, FlowGraphVector>.constructor`
