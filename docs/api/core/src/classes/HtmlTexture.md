...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / HtmlTexture
...
As with [HtmlElementTexture](HtmlElementTexture.md), updates are not automatic unless `autoUpdate` is enabled; in
...
Defines the HTML element to render into the texture

##### options

[`IHtmlTextureOptions`](../interfaces/IHtmlTextureOptions.md)

Defines the texture creation options
...
Defines whether the texture should be inverted on Y (true by default)
