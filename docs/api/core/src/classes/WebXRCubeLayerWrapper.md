...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / WebXRCubeLayerWrapper

# Class: WebXRCubeLayerWrapper

Defined in: [packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts:303](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts#L303)
...
- [`WebXRSpatialLayerWrapper`](WebXRSpatialLayerWrapper.md)\<`XRCubeLayer`, `"XRCubeLayer"`\>

## Constructors

### Constructor

> **new WebXRCubeLayerWrapper**(`getWidth`, `getHeight`, `layer`, `isStatic`, `usesSessionReferenceSpace`, `_binding`, `transformNode`, `ownsTransformNode`): `WebXRCubeLayerWrapper`

Defined in: [packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts:309](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts#L309)
...
> **createRTTProvider**: (`xrSessionManager`) => `WebXRLayerRenderTargetTextureProvider`\<`"XRCubeLayer"`\>
...
`WebXRLayerRenderTargetTextureProvider`\<`"XRCubeLayer"`\>
...
> `readonly` **layerType**: `"XRCubeLayer"`
...
[`WebXRMediaLayerWrapper`](WebXRMediaLayerWrapper.md).[`transformNode`](WebXRMediaLayerWrapper.md#transformnode)
...
Defined in: [packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts:307](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts#L307)
...
[`WebXRMediaLayerWrapper`](WebXRMediaLayerWrapper.md).[`usesSessionReferenceSpace`](WebXRMediaLayerWrapper.md#usessessionreferencespace)
...
> **createRenderTargetTextureProvider**(`xrSessionManager`): `WebXRLayerRenderTargetTextureProvider`\<`"XRCubeLayer"`\>
...
> **getSubImage**(`frame`, `eye?`): `XRWebGLSubImage` \| `XRGPUSubImage`

Defined in: [packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts:340](https://github.com/BabylonJS/Babylon.js/blob/8fc9bce8645980fefc18c7550fb28469d6da3a62/packages/dev/core/src/XR/features/Layers/WebXRCompositionLayer.ts#L340)
...
the eye to retrieve for stereo cube layers

#### Returns

`XRWebGLSubImage` \| `XRGPUSubImage`

the raw WebGL or WebGPU cube subimage
