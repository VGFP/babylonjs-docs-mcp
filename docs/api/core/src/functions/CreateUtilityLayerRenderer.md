...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / CreateUtilityLayerRenderer

# Function: CreateUtilityLayerRenderer()

> **CreateUtilityLayerRenderer**(`frameFraph`, `handleEvents?`): [`UtilityLayerRenderer`](../classes/UtilityLayerRenderer.md)

Defined in: [packages/dev/core/src/FrameGraph/frameGraphUtils.ts:33](https://github.com/BabylonJS/Babylon.js/blob/f22fdbe48b108ab1ffb5586a12fa5a7b3060d09d/packages/dev/core/src/FrameGraph/frameGraphUtils.ts#L33)
