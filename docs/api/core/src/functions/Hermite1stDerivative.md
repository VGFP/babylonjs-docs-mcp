...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / Hermite1stDerivative

# Function: Hermite1stDerivative()

> **Hermite1stDerivative**(`value1`, `tangent1`, `value2`, `tangent2`, `time`): `number`

Defined in: [packages/dev/core/src/Maths/math.scalar.functions.ts:120](https://github.com/BabylonJS/Babylon.js/blob/f22fdbe48b108ab1ffb5586a12fa5a7b3060d09d/packages/dev/core/src/Maths/math.scalar.functions.ts#L120)
